<html lang="en">
    <head>
        ...
        #main{
            ...
            background: linear-gradient(to bottom, #ff99ff 0%, #6699ff 100%);
            /*background: linear-gradient(-45deg,#66ff33,#3366ff,#FF00FF);
            #FF00FF,#0099FF*/
...
<div id = "main">
<div class="topnav">
<h1 style="margin-left: 12px;font-family: Arial, sans-serif">School Management System</h1>
</div>
