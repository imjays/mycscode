...
<div class=form-container><div id="register-form">
<center><h1 style="color:dodgerblue">Registration</h1></center>
<form name="register" action="registration.php" onsubmit="return captcha()" method="POST" >
...
<center>
<button class="login button"><a href="login">Already Registered !</a></button>    
...
<script>  
            ...
            {  
                ...
                var num3 = document.register.val.value; 
                var num4 = num1 + num2;
